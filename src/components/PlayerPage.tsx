...
import { ChevronDown, MoreVertical, Shuffle, SkipBack, Play, Pause, SkipForward, Repeat, Clock, List, Repeat1, MessageSquare } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        {/* Center Area */}
        <div className="flex-1 flex flex-col items-center justify-center px-8 min-h-0 relative">
                      ...
                      lyrics.map((lyric, idx) => {
                         ...
                         return (
                            <p
                               key={idx}
                               className={cn(
                                  "text-xl md:text-3xl font-bold transition-all duration-500 px-4",
        ...
        {/* Bottom Controls */}
        <div className="px-8 pb-12 pt-6 w-full max-w-3xl mx-auto flex-shrink-0">
          ...
          <div className="flex items-center justify-between mb-6">
             ...
             <button 
                ...
                className={cn(
                   "p-2.5 rounded-full transition-colors ml-4",
